...
int size_of_type(int type) {
    ...
    if (type == SearchResultValueTypeUInt8) {
        ...
        size = 0; // 字符串的大小是动态的，由value_of_type函数处理
    }
    return size;
}
...
void print_chain(search_result_chain_t chain) {
    ...
    //Modify by innovator
    if (type == SearchResultValueTypeUInt8) {
        uint8_t v = (chain->result->value.uint8Value);
        printf("%u", v);
    } else if (type == SearchResultValueTypeSInt8) {
        int8_t v = (chain->result->value.sint8Value);
        printf("%d", v);
    } else if (type == SearchResultValueTypeUInt16) {
        uint16_t v = (chain->result->value.uint16Value);
        printf("%u", v);
    } else if (type == SearchResultValueTypeSInt16) {
        int16_t v = (chain->result->value.sint16Value);
        printf("%d", v);
    } else if (type == SearchResultValueTypeUInt32) {
        uint32_t v = (chain->result->value.uint32Value);
        printf("%u", v);
    } else if (type == SearchResultValueTypeSInt32) {
        int32_t v = (chain->result->value.sint32Value);
        printf("%d", v);
    } else if (type == SearchResultValueTypeUInt64) {
        uint64_t v = (chain->result->value.uint64Value);
        printf("%llu", v);
    } else if (type == SearchResultValueTypeSInt64) {
        int64_t v = (chain->result->value.sint64Value);
        printf("%lld", v);
    } else if (type == SearchResultValueTypeFloat) {
        float v = (chain->result->value.floatValue);
        printf("%f", v);
    } else if (type == SearchResultValueTypeDouble) {
        double v = (chain->result->value.doubleValue);
        printf("%f", v);
    } else if (type == 11) { // 字符串类型
        char *v = (char *)(chain->result->value.charValue);
        if (v) {
            printf("\"%s\"", v);
        } else {
            printf("(null)");
...
//    memcpy(result->value, value, size);
    ...
    if (type == SearchResultValueTypeUInt8) {
        uint8_t vv = *(uint8_t *)(value);
        result->value.uint8Value = vv;
    } else if (type == SearchResultValueTypeSInt8) {
        int8_t vv = *(int8_t *)(value);
        result->value.sint8Value = vv;
    } else if (type == SearchResultValueTypeUInt16) {
        uint16_t vv = *(uint16_t *)(value);
        result->value.uint16Value = vv;
    } else if (type == SearchResultValueTypeSInt16) {
        int16_t vv = *(int16_t *)(value);
        result->value.sint16Value = vv;
    } else if (type == SearchResultValueTypeUInt32) {
        uint32_t vv = *(uint32_t *)(value);
        result->value.uint32Value = vv;
    } else if (type == SearchResultValueTypeSInt32) {
        int32_t vv = *(int32_t *)(value);
        result->value.sint32Value = vv;
    } else if (type == SearchResultValueTypeUInt64) {
        uint64_t vv = *(uint64_t *)(value);
        result->value.uint64Value = vv;
    } else if (type == SearchResultValueTypeSInt64) {
        int64_t vv = *(int64_t *)(value);
        result->value.sint64Value = vv;
    } else if (type == SearchResultValueTypeFloat) {
        float vv = *(float *)(value);
        result->value.floatValue = vv;
    } else if (type == SearchResultValueTypeDouble) {
        double vv = *(double *)(value);
        result->value.doubleValue = vv;
    } else if (type == 11) { // 字符串类型
        result->value.charValue = (char *)malloc(size + 1);
        memcpy(result->value.charValue, value, size);
        result->value.charValue[size] = '\0'; // 确保字符串以NULL结尾
    }
